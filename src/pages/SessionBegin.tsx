        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full min-h-[600px]">
          ...
          <div className="flex flex-col h-full space-y-4 overflow-y-auto pr-2">
            ...
            <div ref={leftTopRef}>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-start space-x-4">
                      <Camera className="h-6 w-6 text-blue-600 mt-1 animate-pulse flex-shrink-0" />
                      <div>
              ...
              {/* 학습 팁 */}
              <Card className="border border-gray-300 rounded-xl flex-shrink-0 mt-4">
                <CardHeader>
            ...
            {/* 서버 연결 상태: 학습팁 아래에 위치 */}
            <div className="mt-4" ref={serverCardRef}>
              <Card className="border border-gray-300 rounded-xl flex flex-col justify-center">
                <CardContent className="py-6 px-4 flex-1 flex flex-col justify-center">
          ...
          {/* 오른쪽 컬럼 - 버튼 높이 동기화 */}
          <div className="flex flex-col h-full w-full max-w-full items-start">
            {/* 캠 프리뷰: 왼쪽 학습팁까지의 높이와 맞춤 */}
            <div style={leftTopHeight ? { height: leftTopHeight } : {}} className="w-full max-w-[704px]">
              <WebcamPreview width={704} height={leftTopHeight || 528} className="w-full h-full object-cover" />
            </div>
            {/* 버튼: 서버 상태 카드 높이와 맞춤 */}
            <div className="flex flex-col w-full max-w-[704px] mt-4" style={serverCardHeight ? { height: serverCardHeight } : {}}>
              <Button
                disabled={connectedCount !== totalCount}
                onClick={startContents}
                size="lg"
                className="w-full h-full border border-gray-300 rounded-xl flex justify-center items-center text-xl font-bold bg-indigo-900 hover:bg-black text-white transition-colors"
              >
                세션 시작
